    ...
    for (var i = 0; i < btns.length; i++) {
      btns[i].addEventListener("click", function (e) {
        handler.open({
          ...
          email: urlEmail,
          description: validCoupon ? couponDesc : "2023 est l'année de ta Renaissance<br> Et elle passera par la Légion<br> Une plateforme en ligne<br> Où nous t'apprenons à gagner<br> De l'argent depuis chez toi.<br> Commence par un essai gratuit, puis<br> Pour 29.99€/mois<br> Sécurise ton abonnement à vie<br> Nous t'attendons à l'interieur.",
